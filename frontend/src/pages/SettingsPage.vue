...
const preferences = reactive({
  ...
  currency: 'USD' as 'USD' | 'EUR' | 'GBP' | 'CNY',
...
<template>
  <div class="space-y-6">
    ...
    <!-- Profile Tab -->
    <main v-if="activeTab === 'profile'" class="space-y-6">
      <!-- Profile Section -->
    ...
    <!-- Preferences Tab -->
    <main v-if="activeTab === 'preferences'" class="space-y-6">
      <div class="rounded-xl border border-neutral-200 bg-white p-6 shadow-sm">
          ...
          <div>
            ...
            <div class="grid grid-cols-3 gap-3">
              <button
                ...
                @click="preferences.theme = option.value as any"
              >
                {{ option.label }}
              </button>
            </div>
